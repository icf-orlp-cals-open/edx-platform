...
CREATE TABLE `badges_badgeassertion` (
  ...
  PRIMARY KEY (`id`),
  KEY `badges_badgeassertion_fbfc09f1` (`user_id`),
  KEY `badges_badgeassertion_ac2488f9` (`badge_class_id`),
  CONSTRAINT `badge_class_id_refs_id_6894c71b` FOREIGN KEY (`badge_class_id`) REFERENCES `badges_badgeclass` (`id`),
  CONSTRAINT `user_id_refs_id_6952d18d` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `badges_badgeclass` (
  ...
  PRIMARY KEY (`id`),
  KEY `badges_badgeclass_a951d5d6` (`slug`),
  KEY `badges_badgeclass_4dda889a` (`issuing_component`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `course_groups_cohortmembership` (
  ...
  KEY `course_groups_cohortmembership_46bc6e96` (`course_user_group_id`),
  KEY `course_groups_cohortmembership_fbfc09f1` (`user_id`),
  CONSTRAINT `course_user_group_id_refs_id_6d392dfc` FOREIGN KEY (`course_user_group_id`) REFERENCES `course_groups_courseusergroup` (`id`),
  CONSTRAINT `user_id_refs_id_33d6f9c0` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `course_overviews_courseoverviewtab` (
  ...
  PRIMARY KEY (`id`),
  KEY `course_overviews_courseoverviewtab_cfcd3f54` (`course_overview_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `oauth_provider_consumer` (
  ...
  PRIMARY KEY (`id`),
  KEY `oauth_provider_consumer_fbfc09f1` (`user_id`),
  CONSTRAINT `user_id_refs_id_d65e24f9` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `oauth_provider_nonce` (
  ...
  PRIMARY KEY (`id`),
  KEY `oauth_provider_nonce_67f1b7ce` (`timestamp`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `oauth_provider_token` (
  ...
  PRIMARY KEY (`id`),
  KEY `oauth_provider_token_fbfc09f1` (`user_id`),
  KEY `oauth_provider_token_6565fc20` (`consumer_id`),
  KEY `oauth_provider_token_31b73438` (`scope_id`),
  CONSTRAINT `consumer_id_refs_id_13c53365` FOREIGN KEY (`consumer_id`) REFERENCES `oauth_provider_consumer` (`id`),
  CONSTRAINT `scope_id_refs_id_e360a524` FOREIGN KEY (`scope_id`) REFERENCES `oauth_provider_scope` (`id`),
  CONSTRAINT `user_id_refs_id_b0c679` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proctoring_proctoredexamreviewpolicy` (
  ...
  PRIMARY KEY (`id`),
  KEY `proctoring_proctoredexamreviewpolicy_fb2598a7` (`set_by_user_id`),
  KEY `proctoring_proctoredexamreviewpolicy_2a65e6a8` (`proctored_exam_id`),
  CONSTRAINT `proctored_exam_id_refs_id_5ae07d5` FOREIGN KEY (`proctored_exam_id`) REFERENCES `proctoring_proctoredexam` (`id`),
  CONSTRAINT `set_by_user_id_refs_id_5fefccd3` FOREIGN KEY (`set_by_user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proctoring_proctoredexamreviewpolicyhistory` (
  ...
  `review_policy` longtext NOT NULL,
  PRIMARY KEY (`id`),
  KEY `proctoring_proctoredexamreviewpolicyhistory_533ede81` (`original_id`),
  KEY `proctoring_proctoredexamreviewpolicyhistory_fb2598a7` (`set_by_user_id`),
  KEY `proctoring_proctoredexamreviewpolicyhistory_2a65e6a8` (`proctored_exam_id`),
  CONSTRAINT `proctored_exam_id_refs_id_fa79726e` FOREIGN KEY (`proctored_exam_id`) REFERENCES `proctoring_proctoredexam` (`id`),
  CONSTRAINT `set_by_user_id_refs_id_9464d7c6` FOREIGN KEY (`set_by_user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proctoring_proctoredexamsoftwaresecurereview` (
  ...
  `reviewed_by_id` int(11),
  `student_id` int(11),
  `exam_id` int(11),
  PRIMARY KEY (`id`),
  KEY `proctoring_proctoredexamsoftwaresecurereview_5418718e` (`attempt_code`),
  KEY `proctoring_proctoredexamsoftwaresecurereview_362d9b12` (`reviewed_by_id`),
  KEY `proctoring_proctoredexamsoftwaresecurereview_42ff452e` (`student_id`),
  KEY `proctoring_proctoredexamsoftwaresecurereview_6b01437f` (`exam_id`),
  CONSTRAINT `exam_id_refs_id_9e24d7c3` FOREIGN KEY (`exam_id`) REFERENCES `proctoring_proctoredexam` (`id`),
  CONSTRAINT `reviewed_by_id_refs_id_b03d5395` FOREIGN KEY (`reviewed_by_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `student_id_refs_id_b03d5395` FOREIGN KEY (`student_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proctoring_proctoredexamsoftwaresecurereviewhistory` (
  ...
  `exam_id` int(11),
  PRIMARY KEY (`id`),
  KEY `proctoring_proctoredexamsoftwaresecurereviewhistory_5418718e` (`attempt_code`),
  KEY `proctoring_proctoredexamsoftwaresecurereviewhistory_362d9b12` (`reviewed_by_id`),
  KEY `proctoring_proctoredexamsoftwaresecurereviewhistory_42ff452e` (`student_id`),
  KEY `proctoring_proctoredexamsoftwaresecurereviewhistory_6b01437f` (`exam_id`),
  CONSTRAINT `exam_id_refs_id_3155e3c0` FOREIGN KEY (`exam_id`) REFERENCES `proctoring_proctoredexam` (`id`),
  CONSTRAINT `reviewed_by_id_refs_id_a1b8fa98` FOREIGN KEY (`reviewed_by_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `student_id_refs_id_a1b8fa98` FOREIGN KEY (`student_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `programs_programsapiconfig` (
  ...
  PRIMARY KEY (`id`),
  KEY `programs_programsapiconfig_16905482` (`changed_by_id`),
  CONSTRAINT `changed_by_id_refs_id_543b227f` FOREIGN KEY (`changed_by_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `self_paced_selfpacedconfiguration` (
  ...
  PRIMARY KEY (`id`),
  KEY `self_paced_selfpacedconfiguration_16905482` (`changed_by_id`),
  CONSTRAINT `changed_by_id_refs_id_938c9399` FOREIGN KEY (`changed_by_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `student_enrollmentrefundconfiguration` (
  ...
  PRIMARY KEY (`id`),
  KEY `student_enrollmentrefundconfiguration_16905482` (`changed_by_id`),
  CONSTRAINT `changed_by_id_refs_id_6070cc15` FOREIGN KEY (`changed_by_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `third_party_auth_ltiproviderconfig` (
  ...
  KEY `third_party_auth_ltiproviderconfig_b552ba7c` (`lti_hostname`),
...
CREATE TABLE `third_party_auth_providerapipermissions` (
  ...
  `provider_id` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `third_party_auth_providerapipermissions_4a4e8ffb` (`client_id`),
  CONSTRAINT `client_id_refs_id_21d0249f` FOREIGN KEY (`client_id`) REFERENCES `oauth2_client` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `verify_student_icrvstatusemailsconfiguration` (
  ...
  `enabled` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `verify_student_icrvstatusemailsconfiguration_16905482` (`changed_by_id`),
  CONSTRAINT `changed_by_id_refs_id_23b4b2f1` FOREIGN KEY (`changed_by_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `verify_student_softwaresecurephotoverification` (
  ...
  KEY `verify_student_softwaresecurephotoverification_a1744007` (`copy_id_photo_from_id`),
  CONSTRAINT `copy_id_photo_from_id_refs_id_6e2bbd1b` FOREIGN KEY (`copy_id_photo_from_id`) REFERENCES `verify_student_softwaresecurephotoverification` (`id`),

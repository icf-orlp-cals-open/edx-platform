...
def certificate_exception_view(request, course_id):
    ...
    :param course_id: course identifier of the course for whom to add/remove certificates exception.
           deleting certificate exception, it will be empty if new certificate exception is being created.
    :return: JsonResponse object with success/error message or certificate exception to sync on the frontend.
    """
    course_key = CourseKey.from_string(course_id)
...
def add_certificate_exception(course_key, student, certificate_exception):
    """
    Add a certificate exception to CertificateWhitelist table. Raises ValueError in case of invalid data.

    :param course_key: identifier of the course whose certificates exception will be added.
